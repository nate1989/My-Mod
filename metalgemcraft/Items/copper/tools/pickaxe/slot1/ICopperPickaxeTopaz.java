...
public class ICopperPickaxeTopaz extends MGCItemPickaxe {

	public ICopperPickaxeTopaz(ToolMaterial material, float damage, float speed) {
		super(material, damage, speed);
		setUnlocalizedName("copperpickaxetopaz");
		setRegistryName("ICopperPickaxeTopaz");
